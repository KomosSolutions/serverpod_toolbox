...
1. **Install the application:**  
   Windows:
    ...
    Linux:
        Open the project in your favourite IDE and run

    Mac OS:
        Open the project in your favourite IDE and run

2. **Manage Projects:** Add a project and set the folder to the top level serverpod folder.
